...
RSpec.feature "Admin creates posts of each status", type: :feature, js: true do
  ...
  scenario 'successfully creates a draft post' do
    ...
    fill_in 'Body', with: "It was little surprise to see the south side of Gotthard Pass, also called the Tremola, top the vote. The 7.3-mile climb has an average gradient of eight per cent and the top five kilometres are cobbled."
    click_button 'Save'
  ...
  scenario 'successfully creates a published post' do
    ...
    fill_in 'Body', with: "Go down the north side of the Gotthard Pass and take a left in Hospental: you are now climbing the Furka. The fourth highest Swiss pass is famous for its big views and the stone pillars which line its many switchbacks."
  ...
  scenario 'successfully creates a scheduled post' do
    ...
    fill_in 'Body', with: "Nufenen (the second highest paved pass in Switzerland) is a beast: it climbs 1,108m in less than eight miles. While this makes an average of 8.5 per cent, there are several long sections above ten per cent."
