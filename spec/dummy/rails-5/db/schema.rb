...
ActiveRecord::Schema.define(version: 20161105203727) do
  ...
  create_table "o_cms_image_galleries", id: false, force: :cascade do |t|
    ...
    t.index ["gallery_id"], name: "index_o_cms_image_galleries_on_gallery_id"
    t.index ["image_id"], name: "index_o_cms_image_galleries_on_image_id"
  end
  ...
  create_table "o_cms_post_categories", id: false, force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_o_cms_post_categories_on_category_id"
    t.index ["post_id"], name: "index_o_cms_post_categories_on_post_id"
  end
